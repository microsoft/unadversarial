...
def frost(x, severity=1):
    ...
    filename = [Path(__file__).parent / './frost_imgs/frost1.png',
                Path(__file__).parent / './frost_imgs/frost2.png',
                Path(__file__).parent / './frost_imgs/frost3.png',
                Path(__file__).parent / './frost_imgs/frost4.jpg',
                Path(__file__).parent / './frost_imgs/frost5.jpg',
                Path(__file__).parent / './frost_imgs/frost6.jpg'][idx]
